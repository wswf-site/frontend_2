...
<template>
  <main class="likes-info-page">
    <h1>좋아요 수 추정 방법</h1>
    <section class="accuracy-info-box">
      <p>
        <strong>⚠️ 좋아요 수는 값이 정확하지 않습니다.</strong><br />본 데이터는 YouTube 공식 API를
        기반으로 한 값이 아니며, 타 사이트로부터 수집한 정보를 기준으로 약 200배를 적용하여 추정한
        수치입니다.
      </p>
      <div class="details">
        <b>X200을 하는 이유</b>
        <p>
          추정값에 ×200을 할 때 그나마 좋아요 수가 실제와 비슷하게 나오는 것 같아 ×200으로
          계산했습니다.
        </p>
        <h2>MEGA CREW 미션 결과</h2>
        <table>
          <thead>
            <tr>
              <th>Team</th>
        ...
        <p>
          이전 미션들을 기준으로 보면, MEGA CREW 미션에는 약 200배 이상의 가중치가 적용되었고 K-POP
          미션은 약 100~150배 수준입니다. 본 사이트에서는 좋아요 수 데이터에 기본적으로
          <strong>200배 가중치</strong>를 적용했으며, ×100 버전 표에서만
          <strong>100배 가중치</strong>로 계산한 결과를 제공합니다.
        </p>
      </div>
    </section>
  </main>
